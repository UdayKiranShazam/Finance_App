    ...
    <View style={styles.rootContainer}>
      <LinearGradient style={styles.rootContainer} colors={[Colors.screen_p, Colors.screen_s]}>
        <View style={styles.rootContainer}>
          ...
          <View style={styles.container}>
            <Text style={{ fontSize: 16, color: '#D9D9D9', fontWeight: '300', paddingBottom: 12 }}>
              On Going Tasks
            </Text>
            ...
            <View
              ...
              />
              <Text style={{ fontSize: 16, color: '#D9D9D9', paddingLeft: 10 }}>
                Adding Podcast Section
              </Text>
            </View>
      ...
      <Modal
        ...
        <Pressable
          ...
          style={{ flex: 1, justifyContent: 'flex-end', marginBottom: '28%' }}>
          <View style={styles.container}>
            <Text style={{ fontSize: 16, color: '#D9D9D9', fontWeight: '300', paddingBottom: 12 }}>
              Done Tasks
            </Text>
