        ...
        <LinearGradient style={styles.rootContainer} colors={[Colors.screen_p,Colors.screen_s]}>
            <View style={styles.rootContainer}>
                ...
                <View style={styles.amountHolder}>
                    <Text style={styles.amtValue}><Text style={styles.rupee}>₹{' '}</Text>45,000.<Text style={styles.paise}>36</Text></Text>
                    <Text style={styles.totalInDate}><Text style={styles.totalInDateText}>Upto</Text> 1st Jul 2023</Text>
                </View>
                <FlatList 
                    data={Expenses}
                    ...
                    renderItem={({item,index}) =>{
                        return(
                            <ListCard title={item.title} tag={item.tag} source={item.icon} id={index} payment={item.payment} amount={item.amount} date={item.date} />
                        )
                    }}
                />
            </View>
