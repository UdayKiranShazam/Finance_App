        ...
        <View style={styles.rootContainer}>
          ...
          <View style={styles.amountHolder}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.amtValue}>
                <Text style={styles.rupee}>₹ </Text>45,000.36
              </Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity
            style={styles.totalHolder}
            onPress={() => navigation.navigate('recentactivity')}>
            <View>
              <Text style={styles.totalInText}>Total Income</Text>
              <Text style={styles.totalInDate}>
                <Text style={styles.totalInDateText}>Upto</Text> 25th Jul 2023
              </Text>
            </View>
            <View>
          ...
          <View style={{ flexDirection: 'row' }}>
            <TouchableOpacity
              style={[styles.sideBtn, styles.sideRBtn]}
              onPress={() => navigation.navigate('expensessource')}>
              <Icon name="arrow-top-right" size={24} color={Colors.white} />
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.sideBtn, styles.sideLBtn]}
