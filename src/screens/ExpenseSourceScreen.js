...
const ExpenseSourceScreen = ({ navigation }) => {
  return (
      ...
      <LinearGradient style={styles.rootContainer} colors={[Colors.screen_p, Colors.screen_s]}>
        <View style={styles.rootContainer}>
          ...
          <View style={styles.emojiHolder}>
            <TouchableOpacity style={styles.emoji}></TouchableOpacity>
            <Text style={styles.infoText}>Add a Emoji</Text>
          </View>
          <View style={{ margin: 20 }} />
          <View style={styles.holder}>
            <Text style={styles.question}>What is the expense?</Text>
            <TextInput style={styles.input} keyboardType="default" editable={false} />
          ...
          <View style={styles.dateTagHolder}>
            <View style={styles.dateHolder}>
              ...
              <TextInput style={styles.tag} editable={false} />
            </View>
            <View style={styles.dateHolder}>
...
export default ExpenseSourceScreen;
