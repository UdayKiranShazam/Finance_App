  ...
  return (
    <View style={styles.rootContainer}>
        ...
        <View style={styles.rootContainer}>
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={styles.imgcircle}>
              <Image
                source={require('../assets/sherlock.jpeg')}
                style={{ width: 90, height: 90, resizeMode: 'cover' }}
              />
            </View>
            <Text style={{ fontSize: 20, color: Colors.white, paddingTop: 20 }}>
              Sherlock Holmes
            </Text>
            <Text style={{ fontSize: 14, color: '#9BA6CA', paddingTop: 10 }}>
              Email id : bakerstreet268@gmail.com
            </Text>
          </View>
          <View style={{ marginHorizontal: 20, marginTop: 40 }}>
            ...
            <View
              ...
              <Text style={{ fontSize: 18, color: '#9BA6CA', paddingLeft: 10, padding: 4 }}>
                IMPS
              </Text>
              <Text style={{ fontSize: 18, color: '#9BA6CA', paddingLeft: 10, padding: 4 }}>
                UPI
      ...
      <Modal
        ...
        <Pressable
          onPress={(e) => e.target == e.currentTarget && setShowModal(false)}
          ...
          <View style={styles.container}>
            ...
            <Text style={{ fontSize: 16, color: '#9BA6CA', paddingLeft: 6, paddingBottom: 5 }}>
              About 37Dev app.
            </Text>
            ...
            <View style={{ backgroundColor: '#364160', borderRadius: 8, padding: 6 }}>
              <Text style={{ fontSize: 14, color: '#9BA6CA', paddingLeft: 6 }}>Uday kiran</Text>
            </View>
          </View>
        </Pressable>
      </Modal>
      ...
      <Modal
        ...
        <Pressable
          onPress={(e) => e.target == e.currentTarget && setShowModal1(false)}
          style={{ flex: 1, justifyContent: 'center' }}>
          <View style={styles.container}>
            <Text
              style={{
            ...
            <View style={{ backgroundColor: '#364160', borderRadius: 8, padding: 6 }}>
              <Text style={{ fontSize: 14, color: '#9BA6CA', paddingLeft: 2 }}>Uday kiran</Text>
            </View>
